...
#feature_columns = feature_columns[:47] + feature_columns[66:]
...
#sorted_df.to_csv(r"D:\Vittoria\Code\data\sorted_importance_glucose_xgboost.csv", index=False)
#sorted_df.to_csv(r"D:\Vittoria\Code\data\sorted_importance_pers_xgboost.csv", index=False)
...
plt.show()
#plt.savefig(r"D:\Vittoria\Code\data\plots\feature_importance_glucose_xgboost.png")
#plt.savefig(r"D:\Vittoria\Code\data\plots\feature_importance_pers_xgboost.png")
...
feature_categories = {
    ...
    "electro-dermal activity": ["Peak_eda_5min_sum","Peak_eda_2hr_mean","EDA_Mean","EDA_Std","EDA_Min","EDA_Max","EDA_q1G","EDA_q3G","EDA_skew"],
    "personalization": ["ID"],
    "sex": ["Gender"],
    "HbA1c": ["HbA1c"]
}
...
#plt.savefig(r"D:\Vittoria\Code\data\plots\feature_importance_pie_pers_xgboost.png")
#plt.savefig(r"D:\Vittoria\Code\data\plots\feature_importance_pie_glucose_xgboost.png")