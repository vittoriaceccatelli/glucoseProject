...
def loop_through_all(chosen_model, label, dataset, foodfeatures):
    ...
    if dataset == "Labeled":
        sorted_df.to_csv(rf"D:\Vittoria\Code\data\gender_balanced_sorted_importance_{chosen_model}_{label}_{dataset}_{foodfeatures}.csv", index=False)
    ...
    #plt.show()
    plt.savefig(fr"D:\Vittoria\Code\data\plots\gender_balanced_feature_importance_bar\{chosen_model}_{label}_{dataset}_{foodfeatures}.png")
    ...
    plt.savefig(rf"D:\Vittoria\Code\data\plots\gender_balanced_feature_importance_pie\{chosen_model}_{label}_{dataset}_{foodfeatures}.png")
